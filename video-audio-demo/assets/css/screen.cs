/* --------------I put the audio player on top for ease------------------------------ */
/* Base                                                                       */
/* ----from videojs.org----------------------- */
audio-player {
  display: block;
...
:root {
  --media-surface-background-color: rgba(255, 255, 255, 0.1);
  --media-surface-backdrop-filter: blur(8px);
  --media-surface-outer-border-color: rgba(255, 255, 255, 0.2);
  --media-surface-inner-border-color: rgba(255, 255, 255, 0.1);
...
video-player {
  display: contents;
video-player {
  display: block; /* Changed from contents */
  max-width: 640px; 
  margin: 20px auto;
  aspect-ratio: 16 / 9;
  position: relative;
